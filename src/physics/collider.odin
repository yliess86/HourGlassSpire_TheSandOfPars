...
slope_surface_y :: proc(s: Slope, world_x: f32) -> f32 {
...
slope_surface_x :: proc(s: Slope, world_y: f32) -> f32 {
...
slope_is_floor :: proc(s: Slope) -> bool {
...
raycast_slope :: proc(
	...
	surface_val :=
		slope_surface_y(slope, origin.x) if axis == 1 else slope_surface_x(slope, origin.y)
