...
player_particles_dust_emit :: proc(
...
player_particles_dust_update :: proc(pool: ^engine.Particle_Pool, dt: f32) {
...
player_particles_step_emit :: proc(pool: ^engine.Particle_Pool, pos: [2]f32) {
	engine.particle_pool_emit(
		pool,
		engine.Particle {
			pos = pos,
...
player_particles_step_update :: proc(pool: ^engine.Particle_Pool, dt: f32) {
	engine.particle_pool_update(pool, dt)
}
