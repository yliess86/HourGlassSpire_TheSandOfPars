...
config_apply :: proc() {
	...
	if val, ok := engine.config_get_f32(&config_game, "SAND_PARTICLE_FRICTION"); ok do SAND_PARTICLE_FRICTION = val
	...
	if val, ok := engine.config_get_u8(&config_game, "SAND_EJECT_MAX_HEIGHT"); ok do SAND_EJECT_MAX_HEIGHT = val
